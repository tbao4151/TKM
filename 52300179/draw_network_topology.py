...
def save_region(filename: str, draw_func, xlim, ylim, figsize=(10, 6)) -> None:
    """Ve rieng mot vung topology de anh tach khong bi lot chu/vat the vung khac."""
    fig, ax = plt.subplots(figsize=figsize)
    setup_canvas(ax, xlim=xlim, ylim=ylim)
    draw_func(ax)
...
def main() -> None:
    ensure_dirs()
    save_full()
    save_region("chi_nhanh_1.png", lambda ax: draw_branch1(ax, include_uplink=False), (0.05, 8.50), (0.50, 8.20))
    save_region("chi_nhanh_2.png", lambda ax: draw_branch2(ax, include_uplink=False), (8.35, 20.55), (0.15, 8.25), figsize=(11, 6))
    save_region("chi_nhanh_3.png", lambda ax: draw_branch3(ax, include_uplink=False), (20.35, 29.95), (0.60, 8.25))
    save_region("mpls_backbone.png", draw_provider, (4.45, 25.35), (9.00, 17.75), figsize=(12, 5.2))
